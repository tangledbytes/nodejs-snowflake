 ...
 */
var getMacID = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, new Promise(function (resolve, reject) {
                getmac_1.getMac(function (err, macID) {
                    if (err)
                        reject(err);
                    resolve({ macID: macID, macIDString: macID.split(':').join('') });
                });
            })];
    });
}); };
